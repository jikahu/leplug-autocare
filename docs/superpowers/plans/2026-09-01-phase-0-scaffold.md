...
- [ ] **Step 2: Inspect what Tailwind setup was generated**
...
- [ ] **Step 1: Add the color tokens as CSS variables + Tailwind v4 `@theme` block**
...
- [ ] **Step 2: Verify the tokens are usable as Tailwind classes**
...
- [ ] **Step 3: Remove the temporary test div**
...
- [ ] **Step 1: Import and configure the fonts via next/font/google**
...
- [ ] **Step 2: Set body/heading defaults in globals.css**
...
- [ ] **Step 2: Remap shadcn's neutral color variables to LePlug tokens**
...
- [ ] **Step 3: Install one component to verify the pipeline works end-to-end**
...
- [ ] **Step 4: Verify the themed button renders**
...
- [ ] **Step 1: Create the lib and component subdirectories**
...
- [ ] **Step 2: Add an empty types barrel so `lib/types` isn't empty before Phase 1 fills it in**
...
- [ ] **Step 3: Replace the default home page with a minimal on-brand placeholder**
...
- [ ] **Step 2: Run the TypeScript compiler in check mode**
...
- [ ] `bg-tarmac`, `text-murram`, `font-heading` (etc.) all resolve to real CSS, not unknown-class no-ops
- [ ] Archivo, Inter, and Big Shoulders Stencil fonts are loaded via `next/font`
- [ ] shadcn/ui is initialized and its theme variables are mapped to LePlug tokens
- [ ] `lib/{types,data,store,utils}` and `components/{ui,layout,product,cart,account}` all exist
- [ ] `npm run lint` and `npx tsc --noEmit` both pass clean
- [ ] Git repo initialized with one commit per task above
