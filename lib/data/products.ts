...
const SEEDS: Record<string, ProductSeed[]> = {
  exterior: [
    ...
    { name: "Windshield & Glass Cleaner (500ml)", subcategory: "wipers", brand: "ClearView", price: 1500, features: ["Streak-free ammonia-free formula", "Cuts through road film and bug residue", "Anti-fog additive"], description: "A streak-free clean for windshields and windows, paired perfectly with fresh wiper blades.", stock: "in_stock", rating: 4.4, reviewCount: 9 },
  ],
  interior: [
    ...
    { name: "5-Piece Car Mat Set", subcategory: "floor-mats", brand: "TerraGuard", price: 5000, tags: ["New"], features: ["Full 5-piece set — front, rear, and center console mats", "Non-slip textured backing", "Durable, easy-wipe surface"], description: "Complete floor coverage for the whole cabin, from the front footwells to the rear bench.", stock: "in_stock", rating: 4.4, reviewCount: 6 },
    { name: "Compact Car First Aid Kit", subcategory: "organizers", brand: "SafeRoad", price: 1300, features: ["Bandages, antiseptic wipes, and gauze", "Compact zip case fits glovebox or door pocket", "Restockable compartments"], description: "A glovebox-sized first aid kit for minor cuts and scrapes on the road.", stock: "in_stock", rating: 4.3, reviewCount: 8 },
  ],
  "performance-service-parts": [
    ...
    { name: "High-Flow Oil Filter", subcategory: "oil-filters", brand: "FlowMax", price: 850, makes: ["Toyota", "Subaru", "Mazda"], features: ["Anti-drainback valve", "High dirt-holding capacity", "Fits most 4-cylinder engines"], description: "Keeps engine oil clean between service intervals.", stock: "in_stock", rating: 4.5, reviewCount: 29, image: "https://images.pexels.com/photos/12555015/pexels-photo-12555015.jpeg" },
    { name: "Iridium Spark Plugs (Set of 4)", subcategory: "spark-plugs", brand: "IgniPro", price: 3600, makes: ["Toyota", "Mitsubishi"], features: ["Iridium center electrode", "Improved fuel efficiency", "100,000km rated lifespan"], description: "Smoother idling and better fuel economy from a cleaner spark.", stock: "in_stock", rating: 4.6, reviewCount: 33, image: "https://images.pexels.com/photos/36086528/pexels-photo-36086528.jpeg" },
    ...
    { name: "Performance Air Filter", subcategory: "oil-filters", brand: "FlowMax", price: 2100, makes: ["Nissan", "Ford"], features: ["Washable and reusable", "Increased airflow", "Direct OEM replacement"], description: "A reusable upgrade that improves throttle response.", stock: "out_of_stock", rating: 4.1, reviewCount: 8, image: "https://images.pexels.com/photos/11074558/pexels-photo-11074558.jpeg" },
    { name: "Radiator Coolant (5L)", subcategory: "oil-filters", brand: "FlowMax", price: 1500, features: ["Pre-mixed 50/50 formula, ready to use", "Corrosion inhibitors protect aluminum and iron components", "Rated to -35°C freeze point with high boil-over protection"], description: "Keeps engine temperatures stable through Nairobi traffic and highway heat, with corrosion protection between service intervals.", stock: "in_stock", rating: 4.3, reviewCount: 6 },
  ],
  "car-care-detailing": [
    { name: "Premium Car Shampoo (1L)", subcategory: "cleaning-products", brand: "ShineWorks", price: 1200, tags: ["Bestseller"], features: ["pH-balanced formula", "Rich foam, safe on wax", "Concentrated — up to 40 washes"], description: "A gentle, high-foam wash that won't strip existing wax.", stock: "in_stock", rating: 4.7, reviewCount: 66, image: "https://images.pexels.com/photos/6872580/pexels-photo-6872580.jpeg" },
    ...
    { name: "Interior Trim Cleaner (500ml)", subcategory: "cleaning-products", brand: "ShineWorks", price: 1100, features: ["Anti-static formula", "UV-fade protection for plastics", "Streak-free finish"], description: "Restores faded interior plastics without a greasy residue.", stock: "in_stock", rating: 4.3, reviewCount: 12, image: "https://images.pexels.com/photos/6873015/pexels-photo-6873015.jpeg" },
    { name: "Glass Cleaner (500ml)", subcategory: "cleaning-products", brand: "ShineWorks", price: 700, tags: ["Bestseller"], features: ["Ammonia-free formula", "Streak-free on tinted windows", "Anti-fog additive"], description: "A safe, streak-free clean for windshields and tinted glass.", stock: "in_stock", rating: 4.5, reviewCount: 28, image: "https://images.pexels.com/photos/6873023/pexels-photo-6873023.jpeg" },
    ...
    { name: "Flamingo Crystal Liquid Wax (473ml)", subcategory: "polish", brand: "Flamingo", price: 1100, tags: ["New"], features: ["Crystal liquid formula for an easy, streak-free application", "Leaves a deep, long-lasting shine", "473ml can — enough for multiple full-body applications"], description: "A brilliant, long-lasting shine that goes on smoothly by hand or machine.", stock: "in_stock", rating: 4.6, reviewCount: 3 },
  ],
  "electronics-security": [
    { name: "1080p Dual Dash Cam", subcategory: "dash-cams", brand: "ViewGuard", price: 7200, tags: ["Bestseller"], features: ["Front and rear 1080p recording", "Night vision sensor", "Loop recording with G-sensor"], description: "Front and rear coverage for evidence you can trust.", stock: "in_stock", rating: 4.6, reviewCount: 44, image: "https://images.pexels.com/photos/1970816/pexels-photo-1970816.jpeg" },
    { name: "Car Alarm & Immobilizer System", subcategory: "alarms", brand: "SecureDrive", price: 5600, makes: ["Toyota", "Subaru", "Nissan"], features: ["Remote arm/disarm", "Shock sensor with adjustable sensitivity", "Engine immobilizer relay"], description: "An extra layer of theft deterrence for street parking.", stock: "in_stock", rating: 4.5, reviewCount: 23, image: "https://images.pexels.com/photos/20435121/pexels-photo-20435121.jpeg" },
    { name: "Rear Parking Sensor Kit (4 Sensors)", subcategory: "parking-sensors", brand: "SecureDrive", price: 3900, features: ["4-sensor rear coverage", "In-cabin audio + display alert", "Simple bumper-mount install"], description: "Confident reversing in tight Nairobi parking spots.", stock: "in_stock", rating: 4.3, reviewCount: 17, image: "https://images.pexels.com/photos/244279/pexels-photo-244279.jpeg" },
    { name: "Bluetooth Car Stereo (Double-DIN)", subcategory: "car-stereo-speakers", brand: "SoundDrive", price: 8900, tags: ["New"], features: ["Bluetooth + USB + AUX input", "7-inch touchscreen display", "Steering wheel control compatible"], description: "Modern connectivity for older stereo units.", stock: "in_stock", rating: 4.4, reviewCount: 13, image: "https://images.pexels.com/photos/6520215/pexels-photo-6520215.jpeg" },
    ...
    { name: "GPS Vehicle Tracker", subcategory: "alarms", brand: "ViewGuard", price: 6800, tags: ["New"], makes: ["Toyota", "Nissan"], features: ["Real-time location via app", "Geofence alerts", "Hidden wiring install"], description: "Track your vehicle's location in real time from your phone.", stock: "in_stock", rating: 4.6, reviewCount: 9, image: "https://images.pexels.com/photos/6169866/pexels-photo-6169866.jpeg" },
  ],
  safety: [
